...
export default class RaceInfo extends Component {
    ...
    content = () => {
        if (!this.isEmptyObject(this.state.data.race)) {
            ...
            const {name, location, status, ticket_status,begin_date,end_date,logo,RaceIntro,MainInformation,SideInformation
                ,mainMark,description,Blind,Ranks} = this.state.data.race;
            return(
